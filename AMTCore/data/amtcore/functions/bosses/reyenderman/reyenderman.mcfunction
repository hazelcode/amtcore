...
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] weapon.mainhand with netherite_sword{Enchantments:[{id:"sharpness",lvl:2},{id:"unbreaking",lvl:5}],reyend:1}
