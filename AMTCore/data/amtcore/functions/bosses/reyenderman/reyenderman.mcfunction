...
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] weapon.mainhand with netherite_sword{Enchantments:[{id:"sharpness",lvl:2},{id:"unbreaking",lvl:5}]}
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] inventory.0 with ender_pearl 16
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] inventory.1 with enchanted_golden_apple 1
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] inventory.2 with totem_of_undying 4
execute in the_end run item replace entity @e[type=enderman,tag=reyenderman] inventory.3 with netherite_sword{Enchantments:[{id:"sharpness",lvl:2},{id:"unbreaking",lvl:5}],reyend:1}
