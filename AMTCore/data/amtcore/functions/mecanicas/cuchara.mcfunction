...
execute as @r[tag=persona1,scores={cucharausos=..2}] run tell @r[tag=revivir] te he revivido ;)
...
execute as @r[tag=revivir] run tell @r[tag=persona1,scores={cucharausos=..2}] me has revivido
