...
# execute in the_end as @e[type=enderman,tag=reyenderman,nbt={DeathTime:1s}] run scoreboard players set @p[scores={reyendermatado=1..},predicate=!amtcore:posicion/aire] reward_reyender 1
